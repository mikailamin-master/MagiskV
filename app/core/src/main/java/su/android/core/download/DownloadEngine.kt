...
import su.android.core.intent
import su.android.core.ktx.set
import su.android.core.utils.ProgressInputStream
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "su.android.DOWNLOAD"
